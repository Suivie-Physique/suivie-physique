create database suivie_physique;
...
INSERT INTO `agent` (`name`,`email`,`mobile_number`, `pwd`, `role`,`create_dt`)
...
CREATE TABLE `accounts` (
                            ...
                            CONSTRAINT `cu_ibfk_1` FOREIGN KEY (`agent_id`) REFERENCES `agent` (`agent_id`) ON DELETE CASCADE
);

INSERT INTO `accounts` (`agent_id`, `account_number`, `account_type`, `branch_address`, `create_dt`)
...
CREATE TABLE `account_transactions` (
                                        ...
                                        CONSTRAINT `acct_user_ibfk_1` FOREIGN KEY (`agent_id`) REFERENCES `agent` (`agent_id`) ON DELETE CASCADE
);



INSERT INTO `account_transactions` (`transaction_id`, `account_number`, `agent_id`, `transaction_dt`, `transaction_summary`, `transaction_type`,`transaction_amt`,
...
CREATE TABLE `loans` (
                         ...
                         KEY `agent_id` (`agent_id`),
                         CONSTRAINT `loan_customer_ibfk_1` FOREIGN KEY (`agent_id`) REFERENCES `agent` (`agent_id`) ON DELETE CASCADE
);

INSERT INTO `loans` ( `agent_id`, `start_dt`, `loan_type`, `total_loan`, `amount_paid`, `outstanding_amount`, `create_dt`)
...
CREATE TABLE `cards` (
                         ...
                         PRIMARY KEY (`card_id`),
                         KEY `agent_id` (`agent_id`),
                         CONSTRAINT `card_agent_ibfk_1` FOREIGN KEY (`agent_id`) REFERENCES `agent` (`agent_id`) ON DELETE CASCADE
);

INSERT INTO `cards` (`card_number`, `agent_id`, `card_type`, `total_limit`, `amount_used`, `available_amount`, `create_dt`)
