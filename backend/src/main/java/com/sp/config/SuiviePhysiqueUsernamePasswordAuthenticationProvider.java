...
public class SuiviePhysiqueUsernamePasswordAuthenticationProvider implements AuthenticationProvider {
    ...
    public SuiviePhysiqueUsernamePasswordAuthenticationProvider(AgentRepository agentRepository, PasswordEncoder passwordEncoder){
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        if (agent.size() > 0) {
            if (passwordEncoder.matches(password, agent.get(0).getPwd())) {
